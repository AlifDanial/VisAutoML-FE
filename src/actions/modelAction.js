...
export const addDataSet = (file, algo, parsedData, columns, values) => (dispatch, getState) => {
    dispatch({type: "ADD_FILE", payload: {file, algo, parsedData, columns, values}});
};

export const addAlgoSelection = (isAuto, algoValue, rangeValue) => (dispatch, getState) => {
    dispatch({type: "ADD_ALGO_SELECTION", payload: {isAuto, algoValue, rangeValue}});
};
