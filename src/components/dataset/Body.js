...
import {addDataSet, addNewModel, getReview} from "../../actions/modelAction";
...
const Body = ({backDialogOpen, setBackDialogOpen}) => {
    ...
    useEffect(() => {
        ...
        setAlgoValue(model.algo);
        setParsedData(model.parsedData);
        setColumns(model.columns);
        setValues(model.values);
        if (model.values) {
            setDisabled(model.values.length > 0);
        }
    }, [model]);
        ...
        >
            <Paper sx={{width: "100%", height: "900px", padding: "20px", borderRadius: "20px"}}>
                            ...
                            <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                                ...
                                <Box style={{display: 'flex', justifyContent: 'space-between'}}>
                                    <Button variant="contained" startIcon={<ArrowBackIos/>}
                                            onClick={() => setTooltipId(9)}>PREVIOUS</Button>
                                    <Button variant="contained" endIcon={<ArrowForwardIos/>}
                                            onClick={() => setTooltipId(11)}>NEXT</Button>
                                </Box>
                            </Box>
                        }
                        placement="left"
                ...
                <CustomTooltip
                    ...
                    title={
                        <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                            <Typography>Uploading your data is simple! Import a CSV file or Select from the
                                Dropdown.</Typography>
                            <Box style={{display: 'flex', justifyContent: 'space-between'}}>
                                <Button variant="contained" startIcon={<ArrowBackIos/>}
                                        onClick={() => setTooltipId(10)}>PREVIOUS</Button>
                                <Button variant="contained" endIcon={<ArrowForwardIos/>}
                                        onClick={() => setTooltipId(12)}>NEXT</Button>
                            </Box>
                        </Box>
                    }
                    placement="top"
                ...
                <Box sx={{height: '60%'}}>
                        ...
                        <CustomTooltip
                            ...
                            title={
                                <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                                    ...
                                    <Box style={{display: 'flex', justifyContent: 'space-between'}}>
                                        <Button variant="contained" startIcon={<ArrowBackIos/>}
                                                onClick={() => setTooltipId(11)}>PREVIOUS</Button>
                                        <Button variant="contained" endIcon={<ArrowForwardIos/>}
                                                onClick={() => setTooltipId(13)}>NEXT</Button>
                                    </Box>
                                </Box>
                            }
                            placement="top"
                                     ...
                                     title={
                                         <React.Fragment>
                                             <Typography color="inherit"
                                                         sx={{fontWeight: "bold", fontFamily: "Open Sans"}}>Which is
                                                 which?</Typography> <br/>
                    ...
                    >
                        Understand the data from each column and identify the target column and identifier column (if
                        any)
                    </Typography>
                    <CustomTooltip
                        ...
                        title={
                            tooltipId === 13 ? (
                                <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                                    ...
                                    <Box style={{display: 'flex', justifyContent: 'space-between'}}>
                                        <Button variant="contained" startIcon={<ArrowBackIos/>}
                                                onClick={() => setTooltipId(12)}>PREVIOUS</Button>
                                        <Button variant="contained" endIcon={<ArrowForwardIos/>}
                                                onClick={() => setTooltipId(14)}>NEXT</Button>
                                    </Box>
                                </Box>
                            ) : (
                                <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                                    <Typography>Identify the relevant columns: These are factors that might influence
                                        your
                                        prediction column. For instance, the number of rooms might affect a house’s
                                        price.</Typography>
                                    <Box style={{display: 'flex', justifyContent: 'space-between'}}>
                                        <Button variant="contained" startIcon={<ArrowBackIos/>}
                                                onClick={() => setTooltipId(13)}>PREVIOUS</Button>
                                        <Button variant="contained" endIcon={<ArrowForwardIos/>}
                                                onClick={() => setTooltipId(100)}>NEXT</Button>
                                    </Box>
                                </Box>
                            )
                        }
                    ...
                    <CustomTooltip
                        ...
                        title={
                            <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                                <Typography>After understanding your dataset and how the relevant columns affect the
                                    prediction column, click on Analyse Data</Typography>
                                <Box style={{display: 'flex', justifyContent: 'space-between'}}>
                                    <Button variant="contained" startIcon={<ArrowBackIos/>}
