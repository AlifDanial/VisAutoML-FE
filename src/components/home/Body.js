...
const Body = () => {
    ...
    const [welcomeDialogOpen, setWelcomeDialogOpen] = useState(0);
    ...
    useEffect(() => {
        const isWelcomeDialogAlreadyOpened = ls.get('isWelcomeDialogAlreadyOpened');
        if (!isWelcomeDialogAlreadyOpened) {
            ls.set('isWelcomeDialogAlreadyOpened', true);
            setWelcomeDialogOpen(1);
        }
    }, [welcomeDialogOpen]);
    ...
    return (
        ...
        >
            <Grid item xs={12} sx={{
                width: "100%", height: "35px", padding: "0px 10px 0px 20px", fontWeight: "900",
          ...
          Dashboard
            ...
            <Grid item xs={12} sx={{width: "100%", height: "220px", marginTop: "0px"}}>
                <Grid container sx={{width: "100%", height: "100%"}}>
                                ...
                                <Grid item xs={12} sx={{width: "100%", height: "25%"}}>
                                    <Grid container>
                                            ...
                                            <FormControl sx={{m: 1, width: "100%"}} size="small">
                                                ...
                                                >
                                                    ...
                                                    <MenuItem value="Regression"
                                                              sx={{fontFamily: "'SF Pro Display', sans-serif",}}>Regression</MenuItem>
                                                    <MenuItem value="Classification"
                                                              sx={{fontFamily: "'SF Pro Display', sans-serif",}}>Classification</MenuItem>
                                                </Select>
                                            </FormControl>
                                        </Grid>
                                        <Grid item xs={4} sx={{padding: "0px 5px 0px 10px", marginTop: "-5px"}}>
                                            <FormControl sx={{m: 1, width: "100%"}} size="small">
                                                <InputLabel
                                                    sx={{marginTop: "1px", fontSize: "12px"}}>Algorithm</InputLabel>
                                                <Select
                                                    sx={{
                                                        backgroundColor: "white",
                                                        height: "35px",
                                                ...
                                                >
                                                    ...
                                                    {
                                                        class1 ? category[class1].map(one => <MenuItem
                                                            sx={{fontFamily: "'SF Pro Display', sans-serif",}}
                                                            key={one.name} value={one.value}>{one.name}</MenuItem>) : ''
                                                    }
                                                </Select>
                                            </FormControl>
                                        </Grid>
                    ...
                    <Grid item xs={3} md={3} lg={3.08} xl={3.16}
                          sx={{width: "100%", height: "100%", backgroundColor: "#F5F5F5", padding: "10px"}}>
                        <Grid container sx={{width: "100%", height: "100%"}}>
                            <Grid item xs={12} sx={{width: "100%", height: "25%"}}>
                                <Typography
                                    sx={{
                                    ...
                                    <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                                        ...
                                        <Box style={{display: 'flex', justifyContent: 'space-between'}}>
                                            <Button variant="contained" startIcon={<ArrowBackIos/>}
                                                    onClick={() => setTooltipId(2)}>PREVIOUS</Button>
                                            <Button variant="contained" endIcon={<ArrowForwardIos/>}
                                                    onClick={() => setTooltipId(4)}>NEXT</Button>
                                        </Box>
                                    </Box>
                                }
                                    ...
                                    <Grid item xs={12} sx={{width: "100%", height: "33%"}}>
                                        <Grid item width="100%" display="flex" justifyContent="space-between">
                                            <Box display="flex" width="70%">
                                                <Grid item>
                                                    <Avatar
                                                        sx={{bgcolor: "#1A97F5"}}><BookmarkBorderOutlinedIcon/></Avatar>
                                                </Grid>
                    ...
                    <Grid item xs={3} md={3} lg={2.75} xl={2.5} sx={{width: "100%", height: "100%", padding: "10px"}}>
                        <Paper sx={{
                            ...
                            <Grid container sx={{width: "100%", height: "100%"}}>
                                ...
                                <Grid item width="100%" height="90%" display="flex" alignItems="center"
                                      justifyContent="space-between" paddingBottom="10px" sx={{}}>
                                    <Grid item xs={5} width="100%" height="100%" display="flex" justifyContent="center"
                                          alignItems="center">
                                        {/* <Paper sx={{
                    position:'absolute',
                    top:'20px',
            ...
            <Grid item xs={9} md={9} lg={9.25} xl={9.5}
                  sx={{width: "100%", height: "740px", backgroundColor: "#F5F5F5"}}>
                <Grid container sx={{width: "100%", height: "100%"}}>
                                            ...
                                            <CustomTooltip
                                                ...
                                                title={
                                                    <Box padding="10px" display="flex" flexDirection="column"
                                                        ...
                                                        <Box style={{display: 'flex', justifyContent: 'space-between'}}>
                                                            <Button variant="contained" startIcon={<ArrowBackIos/>}
                                                                    onClick={() => setTooltipId(4)}>PREVIOUS</Button>
                                                            <Button variant="contained"
                                                                    onClick={() => setTooltipId(6)}>OKAY</Button>
                                                        </Box>
                                                    </Box>
                                                }
                                                placement="left"
                                ...
                                <CustomTooltip
                                    ...
                                    title={
                                        <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                                            ...
                                            <Box style={{display: 'flex', justifyContent: 'space-between'}}>
                                                <Button variant="contained" startIcon={<ArrowBackIos/>}
                                                        onClick={() => setTooltipId(3)}>PREVIOUS</Button>
                                                <Button variant="contained" endIcon={<ArrowForwardIos/>}
                                                        onClick={() => setTooltipId(5)}>NEXT</Button>
                                            </Box>
                                        </Box>
                                    }
                                    placement="top"
            ...
            <Grid item xs={3} md={3} lg={2.75} xl={2.5}
                  sx={{width: "100%", height: "740px", backgroundColor: "#F5F5F5"}}>
                <CustomTooltip
                        ...
                        <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                            ...
                            <Box style={{textAlign: "end"}}>
                                <Button variant="contained" endIcon={<ArrowForwardIos/>}
                                        onClick={() => setTooltipId(3)}>PREVIOUS</Button>
                                <Button variant="contained" endIcon={<ArrowForwardIos/>}
                                        onClick={() => setTooltipId(3)}>NEXT</Button>
                            </Box>
                        </Box>
                    }
                    placement="bottom-start"
                            ...
                            <Paper sx={{width: "100%", height: "100%", padding: "20px", borderRadius: "20px"}}>
                                <Grid container sx={{width: "100%", height: "100%"}}>
                                    ...
                                    <Grid item xs={12} sx={{width: "100%", height: "25%"}}>
                                        ...
                                        >
                                            <Chip label="ML Pipeline" sx={{
                                                fontFamily: "'SF Pro Display', sans-serif",
                                                borderRadius: "4px"
                                            }}/> <Chip label="AutoML" sx={{
                                            fontFamily: "'SF Pro Display', sans-serif",
                                            borderRadius: "4px"
                                        }}/>
                                        </Box>
                            ...
                            <Paper sx={{width: "100%", height: "100%", padding: "20px", borderRadius: "20px"}}>
                                <Grid container sx={{width: "100%", height: "100%"}}>
                                    ...
                                    <Grid item xs={12} sx={{width: "100%", height: "25%"}}>
                                        ...
                                        >
                                            <Chip label="Quality" sx={{
                                                fontFamily: "'SF Pro Display', sans-serif",
                                                borderRadius: "4px"
                                            }}/> <Chip label="Preprocessing" sx={{
                                            fontFamily: "'SF Pro Display', sans-serif",
                                            borderRadius: "4px"
                                        }}/>
                                        </Box>
